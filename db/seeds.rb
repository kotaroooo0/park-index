...
Park.create!(name: '47parks', item: 20, level: '1~10', skiresort_id: 6)
Park.create!(name: 'いいもりパーク', item: 15, level: '2~5', skiresort_id: 7)
Park.create!(name: 'TGpark', item: 15, level: '5~10', skiresort_id: 9)
Park.create!(name: 'メインパーク', item: 10, level: '7~9', skiresort_id: 10)
Park.create!(name: '宮パー', item: 6, level: '5~7', skiresort_id: 10)
Park.create!(name: 'チャレンジパーク', item: 10, level: '1~4', skiresort_id: 10)
Park.create!(name: 'The active', item: 40, level: '1~10', skiresort_id: 19)
