...
ActiveRecord::Schema.define(version: 20180417163230) do
  ...
  create_table "lane_users", force: :cascade do |t|
    t.integer "lane_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lane_id"], name: "index_lane_users_on_lane_id"
    t.index ["user_id"], name: "index_lane_users_on_user_id"
  end
